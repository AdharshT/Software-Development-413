package LinkedListWithIterator;//package LinkedListWithIterator;

import java.util.*;
/**
 A driver that demonstrates the revised class LinkedListWithIterator.
 */
public class Driver {
    ...
    public static void main (String args[]){
        ...
        displayList(myList); // Display the list using an iterator
    ...
    // Displays the contents of the list using an iterator.
